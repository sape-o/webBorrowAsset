...
function query_generation_all_admin() {// ไม่ได้ใช้ ทำเผื่อเฉยๆ
  global $db_ip,$db_user,$db_pwd,$dbname,$handle;
  $handle=new mysqli($db_ip, $db_user, $db_pwd,$dbname);
  $handle->set_charset('utf8');
  if(!$handle){
    ...
    $query_generation = "SELECT generation.generation_id,generation.generation_name FROM generation";
...
function query_nature_all_admin() {// ไม่ได้ใช้ ทำเผื่อเฉยๆ
  global $db_ip,$db_user,$db_pwd,$dbname,$handle;
  $handle=new mysqli($db_ip, $db_user, $db_pwd,$dbname);
  $handle->set_charset('utf8');
  if(!$handle){
    ...
    $query_nature = "SELECT nature.nature_id,nature.nature_name FROM nature";
