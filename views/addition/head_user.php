<?php
  ...
  if($index_check!='user_type2') {
    ...
    <h1>Not Found</h1>
    <p>The requested URL /b5813872/views/addition/head_user.php was not found on this server.</p>
    <hr>
 ...
 <html style="background: #F3F2F2;">
   <head>
     <title><?php echo $_SESSION["firstname"]." ".$_SESSION["lastname"] ?></title>
      ...
      <link rel="stylesheet" href="public/css/bulma/css/bulma-badge.min.css">
