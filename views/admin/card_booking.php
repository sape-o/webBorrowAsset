<?php
  if($index_check!='user_type1') {
    ...
    <h1>Not Found</h1>
    <p>The requested URL /b5813872/views/admin/card_booking.php was not found on this server.</p>
    <hr>
...
?>
 <!-- cardloop จอง-->
       ...
       <?php
         ...
         $json_book = query_book_all_admin();
             ...
             foreach($book as $key=>$book) {
               ...
               if($state_book==$book->borrow_id) {
                 if($print_head_card==0) {
                   ...
                   echo "&nbsp;&nbsp;&nbsp;
                        <button class='button is-info' style='width:100px;' onclick='commit_book(".$book->borrow_id.")' >ยืนยันการยืม</button>";
                   echo "<br><hr>";
                  $print_head_card=1;
                  ...
                  echo '<tr>
                    ...
                    <td><button  class="button is-danger" style="width:90%;" onclick="delete_book('.$book->transection_id.')">ลบรายการ</button>
                    </td></tr>';
